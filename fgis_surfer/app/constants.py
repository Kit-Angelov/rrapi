...
textfield_class = 'v-textfield'
button_class = 'v-button-caption'
menu_link_class = 'v-button-link'
filterselect_input_class = 'v-filterselect-input'
popup_class = 'gwt-MenuItem'
table_cell_cad_num_class = 'v-table-cell-content-cadastral_num'
order_num_class = 'v-label-undef-w'
object_list_class = 'v-table-row-odd'
table_order_class = 'v-table-table'
table_order_cell_class = 'v-table-cell-content'